...
// A comment
$comment = new \tyttam\PhpWord\Element\Comment('Authors name', new \DateTime(), 'my_initials');
...
$commentWithStartAndEnd = new \tyttam\PhpWord\Element\Comment('Foo Bar', new \DateTime());
...
$commentOnImage = new \tyttam\PhpWord\Element\Comment('Mr Smart', new \DateTime());
...
$comment1 = new \tyttam\PhpWord\Element\Comment('Authors name', new \DateTime(), 'my_initials');
