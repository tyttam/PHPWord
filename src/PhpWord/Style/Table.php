...
{
    /**
     * @deprecated Use \tyttam\PhpWord\SimpleType\TblWidth::AUTO instead
     */
    const WIDTH_AUTO = 'auto'; // Automatically determined width
    /**
     * @deprecated Use \tyttam\PhpWord\SimpleType\TblWidth::PERCENT instead
     */
    const WIDTH_PERCENT = 'pct'; // Width in fiftieths (1/50) of a percent (1% = 50 unit)
    /**
     * @deprecated Use \tyttam\PhpWord\SimpleType\TblWidth::TWIP instead
     */
     ...
     * Position
     *
     * @var \tyttam\PhpWord\Style\TablePosition
     */
    private $position;
     ...
     * Get position
     *
     * @return \tyttam\PhpWord\Style\TablePosition
     */
