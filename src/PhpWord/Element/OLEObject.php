...
use tyttam\PhpWord\Exception\InvalidObjectException;
...
class OLEObject extends AbstractElement
{
     ...
     * @param mixed $style
     *
     * @throws \tyttam\PhpWord\Exception\InvalidObjectException
     */
     ...
     * Get object style
     *
     * @return \tyttam\PhpWord\Style\Image
     */
