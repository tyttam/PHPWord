...
use tyttam\PhpWord\Style\TOC as TOCStyle;
...
class TOC extends AbstractElement
{
     ...
     * Font style
     *
     * @var \tyttam\PhpWord\Style\Font|string
     */
    private $fontStyle;
    ...
    public function getTitles()
    {
        ...
        foreach ($titles as $i => $title) {
            /** @var \tyttam\PhpWord\Element\Title $title Type hint */
     ...
     * Get TOC Style
     *
     * @return \tyttam\PhpWord\Style\TOC
     */
     ...
     * Get Font Style
     *
     * @return \tyttam\PhpWord\Style\Font|string
     */
