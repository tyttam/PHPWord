 ...
 *
 * @method \tyttam\PhpWord\Element\OLEObject addObject(string $source, mixed $style = null) deprecated, use addOLEObject instead
 *
 * @since 0.10.0
 */
abstract class AbstractContainer extends AbstractElement
{
    ...
    protected function addElement($elementName)
    {
        ...
        /** @var \tyttam\PhpWord\Element\AbstractElement $element Type hint */
     ...
     *
     * @param int $index
     * @return \tyttam\PhpWord\Element\AbstractElement|null
     */
     ...
     *
     * @param int|\tyttam\PhpWord\Element\AbstractElement $toRemove
     */
    public function removeElement($toRemove)
    {
        ...
        } elseif ($toRemove instanceof \tyttam\PhpWord\Element\AbstractElement) {
     ...
     * @param mixed $paragraphStyle
     *
     * @return \tyttam\PhpWord\Element\Footnote
     *
     * @codeCoverageIgnore
     */
