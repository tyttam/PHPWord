...
class Container extends AbstractElement
{
     ...
     * @var string
     */
    protected $namespace = 'tyttam\\PhpWord\\Writer\\HTML\\Element';
    ...
    public function write()
    {
        ...
        foreach ($elements as $element) {
            ...
            $writerClass = str_replace('tyttam\\PhpWord\\Element', $this->namespace, $elementClass);
            if (class_exists($writerClass)) {
                /** @var \tyttam\PhpWord\Writer\HTML\Element\AbstractElement $writer Type hint */
