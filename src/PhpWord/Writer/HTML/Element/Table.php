...
class Table extends AbstractElement
{
    ...
    {
        if (!$this->element instanceof \tyttam\PhpWord\Element\Table) {
            return '';
        }
        ...
        if ($rowCount > 0) {
            ...
            for ($i = 0; $i < $rowCount; $i++) {
                /** @var $row \tyttam\PhpWord\Element\Row Type hint */
     ...
     *
     * @param string|\tyttam\PhpWord\Style\Table|null $tableStyle
     * @return string
     */
    private function getTableStyle($tableStyle = null)
    {
        ...
        if (is_string($tableStyle)) {
            ...
            $style = ' style="';
            if ($tableStyle->getLayout() == \tyttam\PhpWord\Style\Table::LAYOUT_FIXED) {
                $style .= 'table-layout: fixed;';
            } elseif ($tableStyle->getLayout() == \tyttam\PhpWord\Style\Table::LAYOUT_AUTO) {
