...
class Paragraph extends AbstractStyle
{
    ...
    /**
     * Writes an \tyttam\PhpWord\Style\Indentation
     *
     * @param null|\tyttam\PhpWord\Style\Indentation $indent
     * @return string
     */
    private function writeIndentation($indent = null)
    {
        if (isset($indent) && $indent instanceof \tyttam\PhpWord\Style\Indentation) {
     ...
     * Writes tabs
     *
     * @param \tyttam\PhpWord\Style\Tab[] $tabs
     * @return string
     */
