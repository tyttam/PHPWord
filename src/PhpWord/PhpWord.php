...
class PhpWord
{
     ...
     *
     * @var \tyttam\PhpWord\Element\Section[]
     */
    ...
    public function __construct()
    {
        ...
        foreach ($collections as $collection) {
            $class = 'tyttam\\PhpWord\\Collection\\' . $collection;
        ...
        foreach ($metadata as $meta) {
            $class = 'tyttam\\PhpWord\\Metadata\\' . $meta;
    ...
    public function __call($function, $args)
    {
        ...
        if (in_array($function, $addCollection)) {
            ...
            /** @var \tyttam\PhpWord\Collection\AbstractCollection $collectionObject */
        ...
        if (in_array($function, $addStyle)) {
            return forward_static_call_array(array('tyttam\\PhpWord\\Style', $function), $args);
        }
     ...
     *
     * @return \tyttam\PhpWord\Metadata\DocInfo
     */
     ...
     * Get protection
     *
     * @return \tyttam\PhpWord\Metadata\Protection
     * @since 0.12.0
     ...
     * Get compatibility
     *
     * @return \tyttam\PhpWord\Metadata\Compatibility
     * @since 0.12.0
     */
     ...
     * Get compatibility
     *
     * @return \tyttam\PhpWord\Metadata\Settings
     * @since 0.14.0
     */
     ...
     * Get all sections
     *
     * @return \tyttam\PhpWord\Element\Section[]
     */
     ...
     *
     * @param int $index
     * @return \tyttam\PhpWord\Element\Section|null
     */
     ...
     * @deprecated 0.12.0
     *
     * @param \tyttam\PhpWord\Metadata\DocInfo $documentProperties
     *
     * @return self
     *
     * @codeCoverageIgnore
