...
use tyttam\PhpWord\Style\AbstractStyle;
use tyttam\PhpWord\Style\Font;
use tyttam\PhpWord\Style\Numbering;
...
class Style
{
     ...
     * @param array|\tyttam\PhpWord\Style\AbstractStyle $styles
     * @return \tyttam\PhpWord\Style\Paragraph
     */
     ...
     *
     * @param string $styleName
     * @param array|\tyttam\PhpWord\Style\AbstractStyle $fontStyle
     * @param array|\tyttam\PhpWord\Style\AbstractStyle $paragraphStyle
     * @return \tyttam\PhpWord\Style\Font
     */
     ...
     *
     * @param string $styleName
     * @param array|\tyttam\PhpWord\Style\AbstractStyle $styleValues
     * @return \tyttam\PhpWord\Style\Numbering
     * @since 0.10.0
     */
     ...
     * @return \tyttam\PhpWord\Style\Table
     */
     ...
     *
     * @param array|\tyttam\PhpWord\Style\AbstractStyle $styles Paragraph style definition
     * @return \tyttam\PhpWord\Style\Paragraph
     */
     ...
     * Get all styles
     *
     * @return \tyttam\PhpWord\Style\AbstractStyle[]
     */
     ...
     *
     * @param string $styleName
     * @return \tyttam\PhpWord\Style\AbstractStyle Paragraph|Font|Table|Numbering
     */
     ...
     *
     * @param string $name
     * @param \tyttam\PhpWord\Style\AbstractStyle $style
     * @param array|\tyttam\PhpWord\Style\AbstractStyle $value
     * @return \tyttam\PhpWord\Style\AbstractStyle
     */
