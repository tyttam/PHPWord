...
/**
 * Test class for tyttam\PhpWord\Style\Section
 *
...
class SectionTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testSettingValue()
    {
        ...
        $this->assertInstanceOf('tyttam\\PhpWord\\Style\\LineNumbering', $oSettings->getLineNumbering());
    ...
    public function testColumnsSpace()
    {
        ...
        $iVal = rand(1, 1000);
        $this->assertInstanceOf('tyttam\\PhpWord\\Style\\Section', $oSettings->setColsSpace($iVal));
        $this->assertEquals($iVal, $oSettings->getColsSpace());

        $this->assertInstanceOf('tyttam\\PhpWord\\Style\\Section', $oSettings->setColsSpace());
        $this->assertEquals(720, $oSettings->getColsSpace());
    }
