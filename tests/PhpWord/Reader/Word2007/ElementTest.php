...
/**
 * Test class for tyttam\PhpWord\Reader\Word2007\Element subnamespace
 */
class ElementTest extends AbstractTestReader
{
    ...
    public function testReadTextBreak()
    {
        ...
        $this->assertInstanceOf('tyttam\PhpWord\Element\TextRun', $elements[0]);
        /** @var \tyttam\PhpWord\Element\TextRun $textRun */
        $textRun = $elements[0];
        $this->assertInstanceOf('tyttam\PhpWord\Element\TextBreak', $textRun->getElement(0));
        $this->assertInstanceOf('tyttam\PhpWord\Element\Text', $textRun->getElement(1));
    ...
    public function testReadListItemRunWithFormatting()
    {
        ...
        $this->assertInstanceOf('tyttam\PhpWord\Element\ListItemRun', $sections->getElement(0));
        $this->assertEquals(0, $sections->getElement(0)->getDepth());

        $listElements = $sections->getElement(0)->getElements();
        $this->assertInstanceOf('tyttam\PhpWord\Element\Text', $listElements[0]);
    ...
    public function testReadTrackChange()
    {
        ...
        /** @var \tyttam\PhpWord\Element\TrackChange $trackChange */
    ...
    public function testReadTab()
    {
        ...
        $this->assertInstanceOf('tyttam\PhpWord\Element\Text', $textRun->getElement(2));
    ...
    public function testReadTitleStyle()
    {
        ...
        $elements = $phpWord->getSection(0)->getElements();
        $this->assertInstanceOf('tyttam\PhpWord\Element\Title', $elements[0]);
        /** @var \tyttam\PhpWord\Element\Title $title */
        $title = $elements[0];
        $this->assertEquals('Title', $title->getStyle());
        $this->assertEquals('This is a non formatted title', $title->getText());

        $this->assertInstanceOf('tyttam\PhpWord\Element\Title', $elements[1]);
        /** @var \tyttam\PhpWord\Element\Title $formattedTitle */
        $formattedTitle = $elements[1];
        $this->assertEquals('Title', $formattedTitle->getStyle());
        $this->assertInstanceOf('tyttam\PhpWord\Element\TextRun', $formattedTitle->getText());
    }
